                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input type="email" className="w-full bg-zinc-50 border border-zinc-200 rounded-xl py-3 pl-11 pr-4 focus:outline-none focus:border-tealAccent focus:ring-1 focus:ring-tealAccent transition-all text-sm" placeholder="john@example.com" />
                                        </div>
                                    </div>
                                    {/* Preferred Date */}
                                    <div>
                                    ...
                                    {/* Condition / Notes */}
                                    <div className="md:col-span-2">
                                        <label className="block text-sm font-bold text-deepNavy mb-2">Reason for Visit / Condition *</label>
                                        <div className="relative">
