                ...
                <div className="lg:w-[40%] flex flex-col justify-center">
                    <div>
                        ...
                        <p className="text-slate-600 leading-relaxed max-w-md font-light text-sm sm:text-base mb-8">
                            A track record of establishing and scaling advanced neurointerventional services, with a focus on acute stroke pathways and complex cerebrovascular care. Dr. Malla is dedicated to providing high-quality, protocol-driven treatment for complex vascular conditions affecting the brain and spine.
                        </p>
                        ...
                        <div className="flex flex-col gap-4 max-w-md">
                            <div className="flex items-center gap-3.5 p-4 rounded-2xl bg-white border border-slate-300 shadow-sm">
                                ...
                                <div>
                                    <span className="block text-[10px] text-slate-400 font-bold uppercase tracking-wider">Current Institution</span>
                                    <span className="text-sm font-bold text-deepNavy">Renai Medicity, Kochi</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div className="absolute inset-0 z-20 flex flex-col justify-end p-8 md:p-10">
                            ...
                            <h5 className="text-xs md:text-sm font-bold text-tealAccent mb-4 pb-4 border-b border-white/20 uppercase tracking-widest flex items-center gap-2">
                                ...
                                Department of Neurology & Behavioural Sciences, Renai Medicity, Kochi
                            </h5>

                            <p className="text-sm md:text-base text-white/80 leading-relaxed font-light">
                                Leading a comprehensive neurointerventional service managing stroke, aneurysm, carotid/intracranial stenosis, and AVM/dAVF. Established 24/7 stroke pathways with multidisciplinary teams.
                            </p>
                        </div>
                    </motion.div>
                </div>
