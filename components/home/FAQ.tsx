...
const faqs = [
    ...
    },
    {
        ...
        answer: "Yes. In addition to medical management (antiplatelets, statins, blood pressure control), moderate-to-severe carotid artery stenosis can be treated using minimally invasive Carotid Artery Stenting (CAS). During CAS, a stent is deployed to widen the narrow segment and a filter is used to capture any emboli, avoiding open surgical carotid endarterectomy."
    },
    {
