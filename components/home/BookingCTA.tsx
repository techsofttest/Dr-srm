        ...
        <section className="relative w-full py-12 lg:py-16 bg-drBlack overflow-hidden group border-t border-white/5">
            ...
            <div className="relative z-10 max-w-[1440px] mx-auto px-5 md:px-[80px]">
                ...
                >
                    ...
                    <h3 className="text-4xl md:text-5xl lg:text-6xl font-serif text-white leading-[1.1] mb-6 drop-shadow-lg">
                        Schedule your <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-drSilver">Neurovascular</span> Evaluation.
                    </h3>
                    <p className="text-drSteel text-lg leading-relaxed max-w-xl mb-8 drop-shadow-md">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto">
                        <Link 
                            href="/appointment"
                            className="flex items-center justify-center gap-3 px-8 py-4 rounded-full bg-white text-drBlack font-bold tracking-widest text-sm hover:scale-105 transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.1)]"
                        >
